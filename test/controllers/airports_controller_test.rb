...
class AirportsControllerTest < ActionController::TestCase
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post :create, airport: { code_iata: @airport.code_iata, latitude: @airport.latitude, longitude: @airport.longitude, nom_airport: @airport.nom_airport }
    end
  ...
  test "should update airport" do
    patch :update, id: @airport, airport: { code_iata: @airport.code_iata, latitude: @airport.latitude, longitude: @airport.longitude, nom_airport: @airport.nom_airport }
    assert_redirected_to airport_path(assigns(:airport))
  end
